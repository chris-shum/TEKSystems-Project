...
public class PaginationAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PaginationAdapter2(Context context) {
    ...
    */
    ...
    protected class MovieVH extends RecyclerView.ViewHolder {
        ...
        public MovieVH(View itemView) {
            ...
            textView = (TextView) itemView.findViewById(R.id.argggggggh);
        }
    }
